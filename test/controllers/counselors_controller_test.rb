...
class CounselorsControllerTest < ActionController::TestCase
  ...
  test "should create counselor" do
    assert_difference('Counselor.count') do
      post :create, counselor: { bio: @counselor.bio, contact: @counselor.contact, name: @counselor.name, school_id: @counselor.school_id }
    end
  ...
  test "should update counselor" do
    patch :update, id: @counselor, counselor: { bio: @counselor.bio, contact: @counselor.contact, name: @counselor.name, school_id: @counselor.school_id }
    assert_redirected_to counselor_path(assigns(:counselor))
  end
